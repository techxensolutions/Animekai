            ...
            <form className='w-full space-y-3'>
              ...
              <div className='border border-black p-4 rounded-xl shadow-lg space-y-3'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <button className='bg-blue-600 px-4 py-2 text-white rounded-lg flex items-center'><Plus className='h-5 w-5 fill-white font-bold'/>Add Sub Link</button>
                </div>
                <div className='flex justify-between items-center'>
                    <span className='font-bold'>Dub Links</span>
                    <button className='bg-green-600 px-4 py-2 text-white rounded-lg flex items-center'><Plus className='h-5 w-5 fill-white font-bold'/>Add Dub Link</button>
                </div>
              </div>
            </form>
